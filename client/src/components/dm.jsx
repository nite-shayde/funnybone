...
// MessageComposer takes place of DM
...
// function DM(props) {
//   const {
//  user, mainViewUser, changeView, selectedContent, setSelectedContent
// } = props;
...
//         <div>
//           <h4 data-target="profile" onClick={handleClick}>
// {' '}
// {mainViewUser.username}
// </h4>
//         </div>
